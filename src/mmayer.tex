...
%\divider
    ...
    \cvsection{SKILLS}
    \cvskillnoprogress{Java, C\#, Javascript, Dart, Node.js, C++}
    \smallskip
    \cvskillnoprogress{React, Flutter}
    \smallskip
    \cvskillnoprogress{Kubernetes, Docker}
    \smallskip
    \cvskillnoprogress{Firebase, AWS}
    \smallskip
    \cvskillnoprogress{Android Development}
    \smallskip
    \cvskillnoprogress{Linux, Git, Microservices, AGILE, SCRUM}
    \smallskip
