...
\begin{document}
    ...
    \begin{fullwidth}
        ...
        \begin{itemize}
            ...
            \item Set up all the good stuff like: RHEL8 (Red Hat Enterprise Linux 8), NGINX (reverse proxy, cache, SSL, HTTP2), Prometheus, Grafana, MongoDB, Elasticsearch, Kibana, Docker.
